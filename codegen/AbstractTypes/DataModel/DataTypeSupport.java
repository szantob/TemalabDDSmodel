...
public class DataTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "AbstractTypes::DataModel::Data";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=AbstractTypes.DataModel.LocationTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment +=AbstractTypes.DataModel.SensorMetaTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += AbstractTypes.DataModel.LocationTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += AbstractTypes.DataModel.SensorMetaTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment +=CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment) ;
        ...
        Object sample) 
    {
        ...
        currentAlignment += AbstractTypes.DataModel.LocationTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.location);

        currentAlignment += AbstractTypes.DataModel.SensorMetaTypeTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            AbstractTypes.DataModel.LocationTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.location, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            AbstractTypes.DataModel.SensorMetaTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.sensorMeta, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.location = (AbstractTypes.DataModel.LocationType)AbstractTypes.DataModel.LocationTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.location, src, false, true, endpoint_plugin_qos);     
                typedDst.sensorMeta = (AbstractTypes.DataModel.SensorMetaType)AbstractTypes.DataModel.SensorMetaTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.sensorMeta, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            AbstractTypes.DataModel.LocationTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            AbstractTypes.DataModel.SensorMetaTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
