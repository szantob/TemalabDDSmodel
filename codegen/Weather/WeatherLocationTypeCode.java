...
public class  WeatherLocationTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_value_tc("Weather::WeatherLocation",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY, VM_NONE.VALUE,DataModel.LocationTypeTypeCode.VALUE, sm);        
        return tc;
    }
}
